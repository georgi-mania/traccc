...
// Output stats
std::atomic_uint64_t n_cells = 0;
std::atomic_uint64_t m_modules = 0;
std::atomic_uint64_t n_clusters = 0;
std::atomic_uint64_t n_measurements = 0;
std::atomic_uint64_t n_space_points = 0;

struct computation {

    traccc::spacepoint_collection operator()(traccc::cell_collection &cells_per_module) {
